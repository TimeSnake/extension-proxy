...
public class Msg {
    ...
    public static void sendMessageToListeners(User sender, User receiver, String msg) {
        String holeMsg = Network.getChat().getSenderPlugin(Plugin.PRIVATE_MESSAGES) + sender.getChatName() + " " + ChatDivider.COLORED_IN + receiver.getChatName() + ChatDivider.SPLITTER + " " + ChatColor.PERSONAL + msg;
